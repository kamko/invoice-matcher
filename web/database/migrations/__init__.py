...
from .add_invoice_attachments import migrate as migrate_invoice_attachments
...
def run_all_migrations(db_path: Path) -> list[str]:
    ...
    if migrate_invoice_attachments(db_path):
        applied.append("add_invoice_attachments")
